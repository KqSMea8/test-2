# coding=utf-8
from app.models import AppModel, LanguageModel, UserModel, CompanyModel, PermissionModel, BluetoothPacketModel, AdminUserModel
...
def schema_admin_user_info(adminUser:AdminUserModel):
  return {
